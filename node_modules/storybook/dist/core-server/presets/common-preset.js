...
import {
  getLastEvents,
  getSessionId
} from "../../_node-chunks/chunk-HVWOO2MA.js";
import {
  invariant
...
import "../../_node-chunks/chunk-YTKYZK7T.js";
import {
  loadConfig
} from "../../_node-chunks/chunk-HQPOTMHL.js";
import {
  require_dist
...
var getComponentVariableName = /* @__PURE__ */ __name(async (name) => {
  const camelCase = await import("../../_node-chunks/camelcase-OHE5UKDS.js");
...
async function searchFiles({
  ...
  const { globby, isDynamicPattern } = await import("../../_node-chunks/globby-RQKPSV62.js");
...
var viteFinal = /* @__PURE__ */ __name(async (existing, options) => {
  ...
  const { viteInjectMockerRuntime } = await import("../../_node-chunks/plugin-WKVGUVZF.js");
  const { viteMockPlugin } = await import("../../_node-chunks/plugin-75MDANON.js");
  const coreOptions = await options.presets.apply("core");
  return {
    ...existing,
    plugins: [
...
var webpackFinal = /* @__PURE__ */ __name(async (config, options) => {
  ...
  const { WebpackMockPlugin } = await import("../../_node-chunks/webpack-mock-plugin-OAQT3XX3.js");
  const { WebpackInjectMockerRuntimePlugin } = await import("../../_node-chunks/webpack-inject-mocker-runtime-plugin-VU5RC5QA.js");
